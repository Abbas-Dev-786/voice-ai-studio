...
const campaigns = [
  ...
  { id: "4", name: "Re-engagement", agent: "Sales Bot", status: "live" as const, contacted: 1100, total: 1100, successRate: "55%", startDate: "Dec 10, 2025" },
];
  ...
  return (
    <div className="space-y-6">
      ...
      {campaigns.length > 0 ? (
        ...
        <EmptyState icon={Megaphone} title="No campaigns yet" description="Launch your first outbound campaign." actionLabel="Create Campaign" onAction={() => navigate("/campaigns/new")} />
      )}
    </div>
  );
}
